...
def make_generator_model():
    ...
    model.add(tf.keras.layers.Dense(LATENT_DIM * 7*7*4, use_bias=False, input_shape=(Z_DIM,), name='Generator.Input'))
    ...
    model.add(tf.keras.layers.Conv2DTranspose(
        LATENT_DIM * 2, (5, 5), strides=(2, 2), padding='same', use_bias=False, name='Generator.1'))
    ...
    model.add(tf.keras.layers.Conv2DTranspose(1, (4, 4), strides=(2, 2),
        padding='same', use_bias=False, activation='tanh', name='Generator.2'))
...
def make_discriminator_model():
    ...
    model.add(tf.keras.layers.Conv2D(
        LATENT_DIM, (5, 5), strides=(2, 2), padding='same', name='Discriminator.Input'))
    model.add(tf.keras.layers.LeakyReLU())
    #model.add(tf.keras.layers.Dropout(0.3))

    model.add(tf.keras.layers.Conv2D(
        LATENT_DIM*2, (5, 5), strides=(2, 2), padding='same', name='Discriminator.1'))
    model.add(tf.keras.layers.LeakyReLU())
    #model.add(tf.keras.layers.Dropout(0.3))

    model.add(tf.keras.layers.Conv2D(
        LATENT_DIM*4, (5, 5), strides=(2, 2), padding='same', name='Discriminator.2'))
    model.add(tf.keras.layers.LeakyReLU())
    #model.add(tf.keras.layers.Dropout(0.3))

    model.add(tf.keras.layers.Flatten())
    model.add(tf.keras.layers.Dense(1, name='Discriminator.3'))
...
def make_inverter_model():
    model = tf.keras.Sequential()
    model.add(tf.keras.layers.Conv2D(
        LATENT_DIM, (5, 5), strides=(2, 2), padding='same', name='Inverter.Input'))
    model.add(tf.keras.layers.LeakyReLU())
    #model.add(tf.keras.layers.Dropout(0.3))

    model.add(tf.keras.layers.Conv2D(
        LATENT_DIM*2, (5, 5), strides=(2, 2), padding='same', name='Inverter.1'))
    model.add(tf.keras.layers.LeakyReLU())
    #model.add(tf.keras.layers.Dropout(0.3))

    model.add(tf.keras.layers.Conv2D(
        LATENT_DIM*4, (5, 5), strides=(2, 2), padding='same', name='Inverter.2'))
    model.add(tf.keras.layers.LeakyReLU())
    #model.add(tf.keras.layers.Dropout(0.3))

    model.add(tf.keras.layers.Flatten())
    model.add(tf.keras.layers.Dense(LATENT_DIM * 8, name='Inverter.3'))
    model.add(tf.keras.layers.Dense(Z_DIM, name='Inverter.4'))
